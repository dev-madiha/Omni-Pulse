...
const page = () => {
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Form Section */}
      <h1 className="text-xl sm:text-2xl py-3">Create New Dedup</h1>
      <form className="bg-white rounded shadow p-6 w-full space-y-4">
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-3 mt-4">
          <Button text="Create Dedub" variant="primary" onClick={undefined} />
          <Button text="Cancel" variant="secondary" onClick={undefined} />
        </div>
      </form>

      {/* Table Section */}
      <h1 className="text-xl sm:text-2xl py-3">Dedup History</h1>
